    ...
    <div class="row">
        <div class="col-xl-4 col-lg-5">
            <div class="card text-center">
                <div class="card-body">
                    <img src="{{ asset('images/' . $admin->image) }}" class="rounded-circle avatar-lg img-thumbnail" alt="profile-image">

                    <h4 class="mb-1 mt-2">{{$admin->name}}</h4>
                    <p class="text-muted">{{ $admin->role == '1' ? 'admin' : 'users' }}</p>
                    ...
                    <div class="text-start mt-3">
                        ...
                        <p class="text-muted mb-2"><strong>Full Name :</strong> <span class="ms-2">{{$admin->name}}</span></p>

                        <p class="text-muted mb-2"><strong>Mobile :</strong><span class="ms-2">{{$admin->phone}}</span></p>

                        <p class="text-muted mb-2"><strong>Email :</strong> <span class="ms-2 ">{{$admin->email}}</span></p>

                        <p class="text-muted mb-1"><strong>Address :</strong> <span class="ms-2">{{$admin->address}}</span></p>
                    </div>
                </div> <!-- end card-body -->
            </div> <!-- end card -->
