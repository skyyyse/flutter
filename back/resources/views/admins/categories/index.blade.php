...
<body>
                            ...
                            <div class="page-title-box">
                                <div class="page-title-right">
                                    <form class="d-flex">
                                        ...
                                        <!-- <a class="btn btn-success" data-bs-toggle="modal" data-bs-target="#fullscreeexampleModal">New users</a> -->
                                    </form>
                                </div>
                                ...
                                <div class="card-body">
                                    <table id="datatable-buttons" class="table striped dt-responsive nowrap w-100 table-hover table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>{{++$key}}</td>
                                                <td style="display: flex;align-items: center;justify-content: center;margin: 30px;padding: 10px;"><img src="{{ asset('images/' . $data->image) }}" alt="" style="height: 38px;border-radius: 2px;"></td>
                                                <td>{{$data->name}}</td>
                                                <td>{{$data->slug}}</td>
                                                ...
                                                <td style="margin: 30px;padding: 10px;">
                                                    <button type="button" value="{{$data->id}}" class="btn btn-outline-danger delete_category" data-bs-toggle="modal" data-bs-target="#centermodal">
                                                        <i class="ri-delete-bin-2-line"></i>
                                                    </button>
                                                    <button type="button" value="{{$data->id}}" class="btn btn-outline-secondary category_id" data-bs-toggle="modal" data-bs-target="#fullscreeexampleModal">
    ...
    @include("admins.categories.delete")
    @include("admins.categories.update")
    <script>
        $.ajaxSetup({
            headers: {
