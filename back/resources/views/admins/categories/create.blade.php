...
<body>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form id="categoryForm">
                                ...
                                <button type="button" onclick="create_categories();" class="btn btn-primary">Create</button>
                                <a href="{{route('categories.index')}}" class="btn btn-primary" style="margin-left: 20px;">Back</a>
                            </form>
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        function create_categories() {
            const create_categories = new bootstrap.Modal(document.getElementById('create_categories'));
            const already_slug = new bootstrap.Modal(document.getElementById('already_slug'));
            ...
            if (name == "" || active == "Not Found" || !fileInput) {
                create_categories.show();
            } else {
                $.ajax({
                    url: "{{ route('catecory.store') }}",
                    type: 'post',
                    data: formData,
                    processData: false,
                    contentType: false,
