                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-start mb-3">
                                        <img src="{{asset('admin/assets/images/users/avatar-1.jpg')}}" class="me-2 rounded-circle" height="42" alt="Brandon Smith">
                                        <div class="w-100">
                                            <h5 class="mb-0">
                                            ...
                                            <div data-simplebar style="max-height: 380px;">
                                                <a href="javascript:void(0);" class="text-body">
                                                    <div class="d-flex align-items-start py-2 px-3">
                                                        <img src="{{asset('admin/assets/images/users/avatar-2.jpg')}}" class="me-2 rounded-circle" height="42" alt="Brandon Smith" />
                                                        <div class="w-100">
                                                            <h5 class="my-0">
                                                ...
                                                <a href="javascript:void(0);" class="text-body">
                                                    <div class="d-flex align-items-start py-2 px-3 bg-light-subtle border-top border-bottom border-light">
                                                        <img src="{{asset('admin/assets/images/users/avatar-5.jpg')}}" class="me-2 rounded-circle" height="42" alt="James Z" />
                                                        <div class="w-100">
                                                            <h5 class="my-0">
                                                ...
                                                <a href="javascript:void(0);" class="text-body">
                                                    <div class="d-flex align-items-start py-2 px-3">
                                                        <img src="{{asset('admin/assets/images/users/avatar-7.jpg')}}" class="me-2 rounded-circle" height="42" alt="Maria C" />
                                                        <div class="w-100">
                                                            <h5 class="my-0">
                                                ...
                                                <a href="javascript:void(0);" class="text-body">
                                                    <div class="d-flex align-items-start py-2 px-3">
                                                        <img src="{{asset('admin/assets/images/users/avatar-10.jpg')}}" class="me-2 rounded-circle" height="42" alt="Rhonda D" />
                                                        <div class="w-100">
                                                            <h5 class="my-0">
                                                ...
                                                <a href="javascript:void(0);" class="text-body">
                                                    <div class="d-flex align-items-start py-2 px-3">
                                                        <img src="{{asset('admin/assets/images/users/avatar-3.jpg')}}" class="me-2 rounded-circle" height="42" alt="Michael H" />
                                                        <div class="w-100">
                                                            <h5 class="my-0">
                                                ...
                                                <a href="javascript:void(0);" class="text-body">
                                                    <div class="d-flex align-items-start py-2 px-3">
                                                        <img src="{{asset('admin/assets/images/users/avatar-6.jpg')}}" class="me-2 rounded-circle" height="42" alt="Thomas R" />
                                                        <div class="w-100">
                                                            <h5 class="my-0">
                                                                <span class="float-end text-muted fw-normal fs-12">Tue</span>
                                                                Thomas R
                                                ...
                                                <a href="javascript:void(0);" class="text-body">
                                                    <div class="d-flex align-items-start py-2 px-3">
                                                        <img src="{{asset('admin/assets/images/users/avatar-8.jpg')}}" class="me-2 rounded-circle" height="42" alt="Thomas J" />
                                                        <div class="w-100">
                                                            <h5 class="my-0">
                                                                <span class="float-end text-muted fw-normal fs-12">Tue</span>
                                                                Thomas J
                                                ...
                                                <a href="javascript:void(0);" class="text-body">
                                                    <div class="d-flex align-items-start py-2 px-3">
                                                        <img src="{{asset('admin/assets/images/users/avatar-4.jpg')}}" class="me-2 rounded-circle" height="42" alt="Ricky J" />
                                                        <div class="w-100">
                                                            <h5 class="my-0">
                                    ...
                                    <div class="row justify-content-between py-1">
                                        <div class="col-sm-7">
                                            <div class="d-flex align-items-start">
                                                <img src="{{asset('admin/assets/images/users/avatar-5.jpg')}}" class="me-2 rounded-circle" height="36" alt="Brandon Smith">
                                                <div>
                                    ...
                                    <ul class="conversation-list p-3" data-simplebar style="max-height: 520px;">
                                        <li class="clearfix">
                                            <div class="chat-avatar">
                                                <img src="{{asset('admin/assets/images/users/avatar-5.jpg')}}" class="rounded" alt="James Z" />
                                                <i>10:00</i>
                                            </div>
                                        ...
                                        <li class="clearfix odd">
                                            <div class="chat-avatar">
                                                <img src="{{asset('admin/assets/images/users/avatar-1.jpg')}}" class="rounded" alt="Geneva M" />
                                                <i>10:01</i>
                                            </div>
                                            <div class="conversation-text">
                                                <div class="ctext-wrap">
                                        ...
                                        <li class="clearfix">
                                            <div class="chat-avatar">
                                                <img src="{{asset('admin/assets/images/users/avatar-5.jpg')}}" alt="James Z" class="rounded" />
                                                <i>10:02</i>
                                            </div>
                                            <div class="conversation-text">
                                                <div class="ctext-wrap">
                                        ...
                                        <li class="clearfix odd">
                                            <div class="chat-avatar">
                                                <img src="{{asset('admin/assets/images/users/avatar-1.jpg')}}" alt="Geneva M" class="rounded" />
                                                <i>10:03</i>
                                            </div>
                                            <div class="conversation-text">
                                                <div class="ctext-wrap">
